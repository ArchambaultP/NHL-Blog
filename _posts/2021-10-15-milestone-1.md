...
```
This screenshot includes a small snippet of our final dataframe with columns : **GamePk**, **GameDuration**, **EventTypeId**, **DateTime**, **PeriodTimeRemaining**, **Period**, **Team.id**, **Team_name**, **player_id**, **Coordinates_x**, **Coordinates_y**, **Strength** (Note that some indexes can be added to optimize performance ).
...
**A counter attack**: If two opposing team shooting events occur in a limited time interval and the positions are sufficiently far apart, it can be considered a counter attack
